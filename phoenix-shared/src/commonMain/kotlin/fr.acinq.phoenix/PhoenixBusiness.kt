...
class PhoenixBusiness(private val ctx: PlatformContext) {
    ...
    val controllers: ControllerFactory = object : ControllerFactory {
        ...
        override fun closeChannelsConfiguration(): CloseChannelsConfigurationController = AppCloseChannelsConfigurationController(loggerFactory, peerManager, walletManager, masterPubkeyPath, chain, util)
    }
}
