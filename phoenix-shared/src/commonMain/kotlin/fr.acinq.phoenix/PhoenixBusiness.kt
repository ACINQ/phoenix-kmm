...
class PhoenixBusiness(private val ctx: PlatformContext) {
    ...
    val controllers: ControllerFactory = object : ControllerFactory {
        ...
        override fun forceCloseChannelsConfiguration(): ForceCloseChannelsConfigurationController = AppForceCloseChannelsConfigurationController(loggerFactory, peerManager, walletManager, masterPubkeyPath, chain)
    }
}
