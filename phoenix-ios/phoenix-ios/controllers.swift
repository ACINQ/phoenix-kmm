...
class MockControllerFactory : ControllerFactory {
    ...
    func displayConfiguration() -> MVIController<DisplayConfiguration.Model, DisplayConfiguration.Intent> { MVIControllerMock(model: DisplayConfigurationView_Previews.mockModel) }
